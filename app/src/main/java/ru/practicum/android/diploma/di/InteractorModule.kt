...
import ru.practicum.android.diploma.vacancy.domain.impl.VacancyDetailsByIDUseCaseImpl
...
val interactorModule = module {
    ...
    factory<VacancyDetailsByIDUseCase> {
        VacancyDetailsByIDUseCaseImpl(get())
    }
